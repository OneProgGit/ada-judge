...
alter table users alter column admin_level set default 'user';

alter type language rename value 'clang' to 'c';
alter type language rename value 'clangpp' to 'cpp';

alter table submissions rename column total_score to score;
alter table submissions rename column total_verdict to verdict;
...
alter table submissions_subgroups_results rename column subgroup_verdict to verdict;
